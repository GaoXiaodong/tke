...
func NewStorage(optsGetter genericregistry.RESTOptionsGetter, privilegedUsername string) *Storage {
	...
	statusStore.ExportStrategy = persistentevent.NewStatusStrategy(strategy)
...
// ValidateExportObjectAndTenantID validate name and tenantID, if success return PersistentEvent
