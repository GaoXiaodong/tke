...
func NewStorage(optsGetter genericregistry.RESTOptionsGetter, privilegedUsername string) *Storage {
	...
	statusStore.ExportStrategy = tappcontroller.NewStatusStrategy(strategy)
...
// ValidateExportObjectAndTenantID validate name and tenantID, if success return TappController
