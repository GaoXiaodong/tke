...
// Strategy implements verification logic for clusterAuthentication.
...
// Validate validates a new clusterAuthentication.
func (s *Strategy) Validate(ctx context.Context, obj runtime.Object) field.ErrorList {
	return ValidateClusterAuthentication(obj.(*platform.ClusterAuthentication))
}
...
func (s *Strategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	return ValidateClusterAuthenticationUpdate(obj.(*platform.ClusterAuthentication), old.(*platform.ClusterAuthentication))
}

// GetAttrs returns labels and fields of a given object for filtering purposes.
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	clusterAuthentication, _ := obj.(*platform.ClusterAuthentication)
	return clusterAuthentication.ObjectMeta.Labels, ToSelectableFields(clusterAuthentication), nil
}

// MatchClusterAuthentication returns a generic matcher for a given label and field selector.
func MatchClusterAuthentication(label labels.Selector, field fields.Selector) storage.SelectionPredicate {
